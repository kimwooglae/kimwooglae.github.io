...
<https://github.com/kimwooglae/kimwooglae.github.io> 에 push 권한이 있다면:

1. git fetch or pull or clone
2. [Jekyll] 설치

```console
$ git clone git@github.com/kimwooglae/kimwooglae.github.io.git
$ cd kimwooglae.github.io
$ bundle install
```

<https://github.com/kimwooglae/kimwooglae.github.io> 에 push 권한이 없다면:

1. <https://github.com/kimwooglae/kimwooglae.github.io> 에서 `Fork` 버튼 클릭하고,
...
```console
$ git clone git@github.com:YOUR_GITHUB_ACCOUNT/kimwooglae.github.io.git
$ cd kimwooglae.github.io
$ git remote add upstream git@github.com:kimwooglae/kimwooglae.github.io.git
$ git fetch upstream
$ git checkout master
